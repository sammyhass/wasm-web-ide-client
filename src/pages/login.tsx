...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div className="mx-auto my-10 max-w-lg rounded-md bg-base-200 p-5 shadow-md">
        <h1 className="text-4xl font-bold">
          {mode === "login" ? "Login" : "Register"}
        </h1>
        <form className="my-5 flex flex-col gap-5" onSubmit={onSubmit}>
          <FormControl
            id="email"
        ...
        <button
          ...
          className={`btn btn-accent btn-sm w-full normal-case`}
